...
<template>
    <v-card>
        ...
        <v-img :src="propiedad?.imagen" height="550px" cover></v-img>

        <div class="bg-blue-grey-lighten-5 d-flex flex-column flex-md-row align-center">

            <v-card-text>
                Precio: <span class="font-weight-bold">{{ formatearPrecio(propiedad?.precio) }}</span>
            </v-card-text>
            ...
            <v-card-text>
                Estacionamientos: <span class="font-weight-bold">{{ propiedad?.estacionamiento }}</span>
            </v-card-text>
        </div>
