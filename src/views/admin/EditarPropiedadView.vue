...
const onSubmit = handleSubmit(async (values) => {
    ...
    const data = {
        ...propiedad,
        imagen: imageUrl.value ? imageUrl.value : imagen,
    ...
    <v-card max-width="800" flat class="mx-auto my-10">
        ...
        <v-form class="mt-10">
            ...
            <div class="my-5">
                ...
                <v-img v-if="imageUrl" :src="imageUrl" class="mb-5 w-33" />
                <v-img v-else :src="propiedad?.imagen" class="mb-5 w-33" />
            </div>
